...
import uo.ri.cws.application.business.paymentmean.VoucherService.VoucherBLDto;
...
public interface PaymentMeanService {
     ...
     * 
     */
    void addCardPaymentMean(CardBLDto card) throws BusinessException;
     ...
     */
    Optional<CardBLDto> findCreditCardById( String id ) throws BusinessException;
	...
	public class CardBLDto extends PaymentMeanBLDto {
