...
public interface InvoicingService {
	 ...
	 * The new invoice will be in NOT_YET_PAID state, the workorders will be marked
	 * as INVOICED
	 ...
	 */
	List<WorkOrderForInvoicingBLDto> findNotInvoicedWorkOrdersByClientDni(String dni)
			throws BusinessException;
	 ...
	 * @throws BusinessException DOES NOT
	 */
	Optional<InvoiceBLDto> findInvoiceByNumber(Long number) throws BusinessException;
	 ...
	 * 		child classes
	 */
	void settleInvoice(String invoiceId, List<ChargeBLDto> charges)
			throws BusinessException;
	...
	public class InvoiceBLDto {
		...
		public InvoiceState state = InvoiceState.NOT_YET_PAID;	// the state PAID, NOT_YET_PAID
