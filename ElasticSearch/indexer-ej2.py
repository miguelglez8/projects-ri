...
def main():
            ...
            "analysis": {
                ...
                "analyzer": {
                    "analizador_personalizado": {
                        "tokenizer":"standard",
                        "filter":["lowercase","palabras_vacias_ingles_porter","estematizacion_ingles","uni_bi_tri_gramas"]
                    }
                }
            }
        },
    ...
    es.indices.create(index="tweets-miguel-2",ignore=400,body=argumentos)
