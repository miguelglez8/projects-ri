...
def main():
    ...
    ELASTIC_PASSWORD = "fHMyaKB8pmzoQeS=k4J4"
            ...
            "analysis": {
                ...
                "analyzer": {
                    "analizador_personalizado": {
                        "tokenizer":"standard",
                        "filter":["lowercase","palabras_vacias_ingles_porter","estematizacion_espanol","uni_bi_tri_gramas"]
                    }
                }
            }
        },
    ...
    es.indices.create(index="tweets-miguel",ignore=400,body=argumentos)
    ...
    fh = open("tweets-20090624-20090626-en_es.ndjson", 'rt')
