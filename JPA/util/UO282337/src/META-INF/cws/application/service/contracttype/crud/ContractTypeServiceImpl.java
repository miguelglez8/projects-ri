...
import uo.ri.cws.application.service.contracttype.crud.command.ListAllContractType;
import uo.ri.cws.application.service.contracttype.crud.command.ListContractTypeByName;
...
public class ContractTypeServiceImpl implements ContractTypeService {
	...
	public Optional<ContractTypeDto> findContractTypeByName(String name) throws BusinessException {
		return executor.execute(new ListContractTypeByName( name ));
	}

	@Override
	public List<ContractTypeDto> findAllContractTypes() throws BusinessException {
		return executor.execute(new ListAllContractType());
	}
